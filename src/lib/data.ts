...
import type { BlogPost, CaseStory, Category, Consulting, Factory, RobotModel, Tour, TourCost, TourContent, TourDay } from "./schemas";
...
export const getModels = () => readJson<RobotModel>("models.json");
