    ...
    <>
      ...
      <section className="bg-warm-parchment">
        <div className="mx-auto max-w-(--container-page) px-5 py-16 lg:px-10">
          ...
          <div className="mt-8 grid grid-cols-1 gap-4 tablet:grid-cols-2 desktop:grid-cols-3">
            {directions.map((direction) => (
              <Link
                key={direction.href}
                href={direction.href}
                className="rounded-card border border-ink bg-canvas p-6 transition-transform hover:-translate-y-1"
              >
